...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		<!--begin::Logo-->
		<a href="<?= base_url() ?>">
			<img alt="Logo2" src="<?= base_url() ?>assets/media/logos/<?= config_item('company_logo') ?>" style=" width: 60%;" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<a href="<?= base_url() ?>" class="brand-logo">
						<img alt="Logo1" src="<?= base_url() ?>assets/media/logos/<?= config_item('company_logo') ?>" style=" width: 40%; " />
					</a>
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<ul class="menu-nav">
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-active" id="home" aria-haspopup="true">
								...
								<li class="menu-item menu-item-submenu" id="students_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url() ?>students" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
								...
								<li class="menu-item menu-item-submenu" id="courses_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url() ?>courses" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<li class="menu-item menu-item-submenu" id="fee_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url() ?>courses/fee" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
