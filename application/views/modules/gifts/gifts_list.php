...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="d-flex flex-column-fluid">
      ...
      <div class="card card-custom">
        <div class="card-header bg-primary">
          <div class="card-title">
            ...
            <h3 class="card-label text-white">List of Gifts</h3>
          </div>
    ...
    <?php $this->load->view('include_modals/gifts_list_modals') ?>

    <script type="text/javascript">
      $('.menu-item-active').removeClass('menu-item-active');

      $('#gifts_menu').addClass('menu-item-open menu-item-here');
      $('#gifts_menu_3').addClass('menu-item-active');
    </script>
    ...
    },
    {
     ...
     $('body').on('click', '#gift_edit_btn', function() {
      ...
      $('#gift_id_edit').val(row.eq(6).text());
     ...
     $('body').on('click', '#gift_delete_btn', function() {
      var row = $(this).closest('tr').children('td');
      $('#gift_id_delete').val(row.eq(6).text());
    });
