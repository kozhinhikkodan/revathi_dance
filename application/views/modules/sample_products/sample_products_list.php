...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="d-flex flex-column-fluid">
      ...
      <div class="card card-custom">
        <div class="card-header bg-primary">
          ...
          <div class="card-body card-body-custom">
            ...
            <!--begin: Datatable-->
            <table class="table table-header-fixed table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="samples_view_table" style="margin-top: 13px !important">
              <thead>
                <tr>
        ...
        <div class="card card-custom mt-5">
          <div class="card-header bg-info">
            <div class="card-title">
              ...
              <h3 class="card-label text-white">List of Transferred Samples</h3>
            </div>
            <div class="card-toolbar">

              <?php if($this->session->userdata('user_role')=='sales_man' && $sample_balance_qty>0) { ?>

                <!--begin::Button-->
                <a data-toggle="modal" data-target="#sample_transfer_add_modal" class="btn btn-pill btn-dark font-weight-bolder">
                  <span class="svg-icon svg-icon-md">
                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!--end::Svg Icon-->
                  </span>Add New Sample Transfer</a>
                  <!--end::Button-->
            ...
            <div class="card-body card-body-custom-info">
              ...
              <!--begin: Datatable-->
              <table class="table table-header-fixed table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="sample_transfers_view_table" style="margin-top: 13px !important">
                <thead>
                  <tr>
    ...
    <?php $this->load->view('include_modals/samples_modals') ?>

    <script type="text/javascript">
      $('.menu-item-active').removeClass('menu-item-active');
      $('#samples_menu').addClass('menu-item-active');
    </script>
    ...
    <script type="text/javascript">
     ...
     var samples_view_table = $('#samples_view_table').DataTable({
       ...
       "ajax":{
        url :"<?= base_url().'Samples/select_gifts' ?>",
        type: "post",
        data: function(d){
    ...
    },
    {
      ...
      targets:[<?php if($this->session->userdata('user_role')=='sales_man'){  ?>6,<?php } ?>7,8,9]
    },{
      className:'noExport',
      targets:[6]
    }
     ...
     $('body').on('change', '#gift_transfer_add', function() {
      ...
      if(gift_id!='' && gift_id!=null && gift_id!='Select Sample'){
        $.post("<?= base_url() ?>Samples/fetch_gift_info",{'gift_id':gift_id},function(data) {
     ...
     var gift_transfers_view_table = $('#gift_transfers_view_table').DataTable({
       ...
       "ajax":{
        url :"<?= base_url().'Samples/select_gift_transfers' ?>",
        type: "post",
        data: function(d){
