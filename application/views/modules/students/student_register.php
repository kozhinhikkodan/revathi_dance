                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <div class="input-icon input-icon-right">
                          <input required type="text" id="student_name" class="form-control form-control-pill form_student_add_fields" name="student_name" value="" />
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="input-icon input-icon-right">
                          <input minlength="10" maxlength="10" required type="text" id="contact_no" class="form-control form-control-pill form_student_add_fields" name="contact_no" value="" />
                          <span><i class="flaticon2 flaticon2-phone icon-md"></i></span>
                        </div>
                        <span class="form-text text-muted"></span>
                      </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>DOB</label>
                        <div class="input-icon input-icon-right">
                          <input type="text" required type="text" id="contact_no" class="form-control form-control-pill form_student_add_fields date-field" name="contact_no" value="" />
                          <span><i class="flaticon2 flaticon-event-calendar-symbol icon-md"></i></span>
                        </div>
                        <span class="form-text text-muted"></span>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <!-- <div class="input-icon input-icon-right"> -->
                            <input required type="text" id="school" class="form-control form-control-pill form_student_add_fields" name="admission_date" />
                            <!-- <span><i class="flaticon2 flaticon-event-calendar-symbol icon-md"></i></span> -->
                            <!-- </div> -->
                            <span class="form-text text-muted"></span>
                          </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <!-- <div class="input-icon input-icon-right"> -->
                              <input required type="text" id="admission_no" class="form-control form-control-pill form_student_add_fields" name="admission_no" value="" />
                              <!-- <span><i class="flaticon2 flaticon2-phone icon-md"></i></span> -->
                              <!-- </div> -->
                              <span class="form-text text-muted"></span>
                            </div>
                              ...
                              <div class="col-5">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <div class="input-icon input-icon-right">
                                      <textarea required rows="3" type="text" id="remarks" class="form-control form-control-pill form_student_add_fields" name="remarks"></textarea>
                         ...
                         <div class="card-footer">
                          <div class="float-right mb-8">
                            <button type="submit" class="btn btn-primary mr-2 float-right form_submit">Register Student</button>
